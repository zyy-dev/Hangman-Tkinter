...
class hover_frame(CTkFrame):
    def __init__ (self, parent: object, width: int, height: int, skill_number: int, character: str, place: bool = True) -> None:
        ...
        CTkLabel(self, text=description, font=("", -10), justify="left", wraplength=int(width-20)).pack(anchor="w", padx=10)